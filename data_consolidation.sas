ods html close; ods html; dm 'output;clear;log;clear;'; 

/* Creates library to store auxiliary data sets */
libname mydata 'C:\Online_Supplement\auxiliary';

/* Read raw data files */
filename Fire_raw 'C:\Online_Supplement\input\Fire_Calls_For_Service.xlsx';
filename Poli_raw 'C:\Online_Supplement\input\Police_Calls_For_Service.xlsx';
filename EMS_raw 'C:\Online_Supplement\input\EMS_Calls_For_Service.xlsx';
